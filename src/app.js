...
app.run(function($rootScope, $state, $stateParams, $window, pmtUploadManager) {
    pmtUploadManager.registerEndpoint('autoNgform.taxReg', {
        request: {
            endpoint: 'http://test.wandoujia.com/api/assets'
        },
        validation: {
